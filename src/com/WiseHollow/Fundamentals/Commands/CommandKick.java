...
public class CommandKick implements CommandExecutor
{
    ...
    public boolean onCommand(CommandSender sender, Command command, String cmd, String[] args)
    {
        ...
        if (args[0].equalsIgnoreCase("all"))
            sender.sendMessage(Language.PREFIX_COLOR + "You have kicked all players for reason: " + reason);
        else if (sender != null)
            sender.sendMessage(Language.PREFIX_COLOR + "You have kicked " + target.getName() + " for reason: " + reason);
