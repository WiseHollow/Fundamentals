...
public class CommandTPS implements CommandExecutor
{
    ...
    public boolean onCommand(CommandSender sender, Command command, String cmd, String[] args)
    {
        ...
        sender.sendMessage(Language.PREFIX_COLOR + "Maximum Memory: " + ChatColor.RESET + maxMemory + "MB");
        sender.sendMessage(Language.PREFIX_COLOR + "Allocated Memory: " + ChatColor.RESET + allocatedMemory + "MB");
        sender.sendMessage(Language.PREFIX_COLOR + "Free Memory: " + ChatColor.RESET + freeMemory + "MB");

        if (sender instanceof Player)
        {
            for(World w : Bukkit.getWorlds())
            {
                TextComponent message = new TextComponent( Language.PREFIX_COLOR + "" + ChatColor.BOLD + "    > " + w.getName() + ChatColor.RESET );
        ...
        else
        {
            for(World w : Bukkit.getWorlds())
            {
                sender.sendMessage(Language.PREFIX_COLOR + "" + ChatColor.BOLD + w.getName() + ChatColor.RESET);
