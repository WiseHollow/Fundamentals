...
{
    public static final String PREFIX = ChatColor.YELLOW + "" + ChatColor.BOLD + "[Fundamentals] "+ ChatColor.RESET;
    public static final String PREFIX_COLOR = ChatColor.YELLOW + "";
